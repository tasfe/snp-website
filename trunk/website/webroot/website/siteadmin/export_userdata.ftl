...
<form name="formadmin" action="siteoperationControl.action?OT.Forward.success.URL=/siteactionresultadmin/exportuserdata.ftl&DM.business.DownSitedata=&userid=${Session["clientlogined"].id}&OT.Forward.success.Type=freemarker" method="post" target="_self" ></form>
<script>
 	function run(){
 		formadmin.submit();
 	}
