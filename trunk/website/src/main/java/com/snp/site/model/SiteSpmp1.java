...
/**
 * @hibernate.class table="site_spmp1"
 * 
 */
public class SiteSpmp1 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8214677543504486944L;
	...
	/** persistent field */
	private Set siteSpmp1Items;

	/** full constructor */
	public SiteSpmp1(String name2, String detail2, String name3, String detai3,
			String name, String detail, String filename, String filepath,
			String imagealign, String sortstr, String width, String height,
			com.snp.site.model.SiteUser siteUser, Set siteSpmp1Items) {
		this.name2 = name2;
		...
		this.siteSpmp1Items = siteSpmp1Items;
	}
	...
	/** minimal constructor */
	public SiteSpmp1(com.snp.site.model.SiteUser siteUser, Set siteSpmp1Items) {
		this.siteUser = siteUser;
		this.siteSpmp1Items = siteSpmp1Items;
	}
	 ...
	 * @hibernate.collection-one-to-many class="com.site.model.SiteSpmp1Item"
	 * 
	 */
	public Set getSiteSpmp1Items() {
		return this.siteSpmp1Items;
	}
	...
	public void setSiteSpmp1Items(Set siteSpmp1Items) {
		this.siteSpmp1Items = siteSpmp1Items;
	}
	...
	public int getSubnumber() {
		if (siteSpmp1Items == null) {
			return 0;
		}
		return siteSpmp1Items.size();
	}

	public String getActionString() {
		return "siteSpmp1Detail";
	}

	public String getTitle() {
		return this.siteUser.getSpmp1Lanmu();
	}

	public String getTitle1() {
		return this.siteUser.getSpmp1Lanmu2();
	}
	...
	public Set getAllItems() {
		return this.siteUser.getSiteSpmp1s();
	}
