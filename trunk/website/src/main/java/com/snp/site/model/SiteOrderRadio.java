...
/**
 * @hibernate.class table="site_order_radio"
 * 
 */
public class SiteOrderRadio implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1644393139936591972L;
	...
	/** persistent field */
	private Set siteOrderRadioItems;

	/** full constructor */
	public SiteOrderRadio(String title, String detail, String title2,
			String detail2, String title3, String detail3, String sortstr,
			com.snp.site.model.SiteUser siteUser, Set siteOrderRadioItems) {
		this.title = title;
		this.detail = detail;
		this.title2 = title2;
		...
		this.siteOrderRadioItems = siteOrderRadioItems;
	}

	/** default constructor */
	public SiteOrderRadio() {
	}

	/** minimal constructor */
	public SiteOrderRadio(com.snp.site.model.SiteUser siteUser,
			Set siteOrderRadioItems) {
		this.siteUser = siteUser;
		this.siteOrderRadioItems = siteOrderRadioItems;
	}
	 ...
	 *                                   class="com.site.model.SiteOrderRadioItem"
	 * 
	 */
	public Set getSiteOrderRadioItems() {
		return this.siteOrderRadioItems;
	}

	public void setSiteOrderRadioItems(Set siteOrderRadioItems) {
		this.siteOrderRadioItems = siteOrderRadioItems;
	}
