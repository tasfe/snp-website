...
/**
 * @hibernate.class table="site_address"
 * 
 */
public class SiteAddress extends Model implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1378227184412280883L;
	...
	/** full constructor */
	public SiteAddress(String title, String detail, String title2,
	...
	/** minimal constructor */
	public SiteAddress(com.snp.site.model.SiteUser siteUser) {
		this.siteUser = siteUser;
	}
