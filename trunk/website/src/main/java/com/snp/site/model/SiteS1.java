...
public class SiteS1 extends Model implements Serializable {

	private static final long serialVersionUID = -6431514560131350564L;
	...
	/** full constructor */
	public SiteS1(String title, String detail, String title2, String detail2,
	...
	/** minimal constructor */
	public SiteS1(com.snp.site.model.SiteUser siteUser) {
		this.siteUser = siteUser;
	}
