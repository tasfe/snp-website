...
/**
 * @hibernate.class table="site_spmp9"
 * 
 */
public class SiteSpmp9 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2467276906030838595L;
	...
	/** persistent field */
	private Set siteSpmp9Items;

	/** full constructor */
	public SiteSpmp9(String name2, String detail2, String name3, String detai3,
			String name, String detail, String filename, String filepath,
			String imagealign, String sortstr, String width, String height,
			com.snp.site.model.SiteUser siteUser, Set siteSpmp9Items) {
		this.name2 = name2;
		...
		this.siteSpmp9Items = siteSpmp9Items;
	}
	...
	/** minimal constructor */
	public SiteSpmp9(com.snp.site.model.SiteUser siteUser, Set siteSpmp9Items) {
		this.siteUser = siteUser;
		this.siteSpmp9Items = siteSpmp9Items;
	}
	 ...
	 * @hibernate.collection-one-to-many class="com.site.model.SiteSpmp9Item"
	 * 
	 */
	public Set getSiteSpmp9Items() {
		return this.siteSpmp9Items;
	}
	...
	public void setSiteSpmp9Items(Set siteSpmp9Items) {
		this.siteSpmp9Items = siteSpmp9Items;
	}

	public Set getAllItems() {
		return this.siteUser.getSiteSpmp9s();
	}
