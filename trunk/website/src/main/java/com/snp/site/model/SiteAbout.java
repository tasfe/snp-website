...
/**
 * @hibernate.class table="site_about"
 * 
 */
public class SiteAbout extends Model implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1763480321241067285L;
	...
	/** full constructor */
	public SiteAbout(String title, String detail, String title2,
	...
	/** minimal constructor */
	public SiteAbout(com.snp.site.model.SiteUser siteUser) {
		this.siteUser = siteUser;
	}
