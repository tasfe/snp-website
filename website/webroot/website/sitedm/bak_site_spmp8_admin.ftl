...
<script type="text/javascript">
	...
	window.onload = function() {
		var settings = {			
			...
			file_types : "*.flv;",//*.mp3;*.avi;*.mov;*.mpg;*.3gp;*.wmv;*.mp4;*.asf;*.asx
			...
			button_width: 180,
			button_height: 18,
			button_text : '<span class="button">上传视频 <span class="buttonSmall"></span></span>',
	...
	function queueComplete(numFilesUploaded) {
		lanmupageadmin(${Session["clientlogined"].id},'site_spmp8_admin.ftl','1','${Session["clientlogined"].local}');
	}
</script>
<script language="javascript">
...
<div class="content"> 
    ...
    -->
   <a class=bt href="siteoperationControl.action?DM.Instance.SiteUser.id=${Session["clientlogined"].id}&DM.Object.SiteUser=SiteUser&DM.Reload.SiteUser=&OT.Forward.success.Type=freemarker&OT.Forward.success.URL=/website/sitedm/upload_spmp8.ftl" title="1次上传多个文件" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )">
				上传文件</a>		
    <br>
     <br> 
