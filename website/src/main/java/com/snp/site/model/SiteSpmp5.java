...
/**
 * @hibernate.class table="site_spmp5"
 * 
 */
public class SiteSpmp5 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7908502213440804084L;
	/** identifier field */
	private Long id;
	...
	/** persistent field */
	private Set siteSpmp5Items;

	/** full constructor */
	public SiteSpmp5(String name2, String detail2, String name3, String detai3,
			String name, String detail, String filename, String filepath,
			String imagealign, String sortstr, String width, String height,
			com.snp.site.model.SiteUser siteUser, Set siteSpmp5Items) {
		this.name2 = name2;
		...
		this.siteSpmp5Items = siteSpmp5Items;
	}
	...
	/** minimal constructor */
	public SiteSpmp5(com.snp.site.model.SiteUser siteUser, Set siteSpmp5Items) {
		this.siteUser = siteUser;
		this.siteSpmp5Items = siteSpmp5Items;
	}
	 ...
	 * @hibernate.collection-one-to-many class="com.site.model.SiteSpmp5Item"
	 * 
	 */
	public Set getSiteSpmp5Items() {
		return this.siteSpmp5Items;
	}

	public void setSiteSpmp5Items(Set siteSpmp5Items) {
		this.siteSpmp5Items = siteSpmp5Items;
	}
	...
	public Set getAllItems() {
		return this.siteUser.getSiteSpmp5s();
	}
