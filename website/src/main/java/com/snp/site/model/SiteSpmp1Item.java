...
/**
 * @hibernate.class table="site_spmp1_item"
 * 
 */
public class SiteSpmp1Item extends Model implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1857703427431527727L;
	...
	/** persistent field */
	private com.snp.site.model.SiteSpmp1 siteSpmp1;

	/** full constructor */
	public SiteSpmp1Item(String sortstr, String detail, String detail2,
			String detail3, String filename, String filepath,
			String imagealign, String width, String height,
			com.snp.site.model.SiteSpmp1 siteSpmp1) {
		...
		this.width = width;
		this.height = height;
		this.siteSpmp1 = siteSpmp1;
	}

	/** default constructor */
	public SiteSpmp1Item() {
	}

	/** minimal constructor */
	public SiteSpmp1Item(com.snp.site.model.SiteSpmp1 siteSpmp1) {
		this.siteSpmp1 = siteSpmp1;
	}
	 ...
	 * 
	 */
	public com.snp.site.model.SiteSpmp1 getSiteSpmp1() {
		return this.siteSpmp1;
	}

	public void setSiteSpmp1(com.snp.site.model.SiteSpmp1 siteSpmp1) {
		this.siteSpmp1 = siteSpmp1;
	}
