...
/**
 * @hibernate.class table="site_spmp2_item"
 * 
 */
public class SiteSpmp2Item extends Model implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2456443517941561661L;
	...
	/** persistent field */
	private com.snp.site.model.SiteSpmp2 siteSpmp2;

	/** full constructor */
	public SiteSpmp2Item(String sortstr, String detail, String detail2,
			String detail3, String filename, String filepath,
			String imagealign, String width, String height,
			com.snp.site.model.SiteSpmp2 siteSpmp2) {
		...
		this.width = width;
		this.height = height;
		this.siteSpmp2 = siteSpmp2;
	}

	/** default constructor */
	public SiteSpmp2Item() {
	}

	/** minimal constructor */
	public SiteSpmp2Item(com.snp.site.model.SiteSpmp2 siteSpmp2) {
		this.siteSpmp2 = siteSpmp2;
	}
	 ...
	 * 
	 */
	public com.snp.site.model.SiteSpmp2 getSiteSpmp2() {
		return this.siteSpmp2;
	}

	public void setSiteSpmp2(com.snp.site.model.SiteSpmp2 siteSpmp2) {
		this.siteSpmp2 = siteSpmp2;
	}
