...
/**
 * @hibernate.class table="site_spmp7"
 * 
 */
public class SiteSpmp7 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5866227153862235871L;
	...
	/** persistent field */
	private Set siteSpmp7Items;

	/** full constructor */
	public SiteSpmp7(String name2, String detail2, String name3, String detai3,
			String name, String detail, String filename, String filepath,
			String imagealign, String sortstr, String width, String height,
			com.snp.site.model.SiteUser siteUser, Set siteSpmp7Items) {
		this.name2 = name2;
		...
		this.siteSpmp7Items = siteSpmp7Items;
	}
	...
	/** minimal constructor */
	public SiteSpmp7(com.snp.site.model.SiteUser siteUser, Set siteSpmp7Items) {
		this.siteUser = siteUser;
		this.siteSpmp7Items = siteSpmp7Items;
	}
	 ...
	 * @hibernate.collection-one-to-many class="com.site.model.SiteSpmp7Item"
	 * 
	 */
	public Set getSiteSpmp7Items() {
		return this.siteSpmp7Items;
	}

	public void setSiteSpmp7Items(Set siteSpmp7Items) {
		this.siteSpmp7Items = siteSpmp7Items;
	}
	...
	public int getSubnumber() {
		if (siteSpmp7Items == null) {
			return 0;
		}
		return siteSpmp7Items.size();
	}

	public Set getAllItems() {
		return this.siteUser.getSiteSpmp7s();
	}
